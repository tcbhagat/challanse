...
class Settings(BaseSettings):
    ...
    ocr_provider: Literal["disabled", "mock", "textract", "local"] = Field(default="disabled", alias="OCR_PROVIDER")
    ...
    event_queue_provider: Literal["disabled", "memory", "sqs", "postgres"] = Field(default="disabled", alias="EVENT_QUEUE_PROVIDER")
    object_store_endpoint: str = Field(default="", alias="OBJECT_STORE_ENDPOINT")
    object_store_access_key: str = Field(default="", alias="OBJECT_STORE_ACCESS_KEY")
    object_store_secret_key: str = Field(default="", alias="OBJECT_STORE_SECRET_KEY")
    object_store_sse_mode: Literal["kms", "none"] = Field(default="kms", alias="OBJECT_STORE_SSE_MODE")
    ...
    tesseract_languages: str = Field(default="eng+hin", alias="TESSERACT_LANGUAGES")
    local_data_root: str = Field(default="/srv/challanse", alias="LOCAL_DATA_ROOT")
    local_storage_limit_bytes: int = Field(default=20_000_000_000, alias="LOCAL_STORAGE_LIMIT_BYTES")
    synthetic_mode: bool = Field(default=False, alias="SYNTHETIC_MODE")
    local_auth_encryption_key: str = Field(default="", alias="LOCAL_AUTH_ENCRYPTION_KEY")
    local_session_ttl_minutes: int = Field(default=480, alias="LOCAL_SESSION_TTL_MINUTES")
    local_acceptance_base_url: str = Field(default="http://edge:8787", alias="LOCAL_ACCEPTANCE_BASE_URL")
    local_build_commit_sha: str = Field(default="unknown", alias="LOCAL_BUILD_COMMIT_SHA")
    local_tls_certificate_path: str = Field(default="", alias="LOCAL_TLS_CERTIFICATE_PATH")
