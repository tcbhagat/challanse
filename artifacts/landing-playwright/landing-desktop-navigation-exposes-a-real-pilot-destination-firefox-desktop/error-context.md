...
- Name: landing.spec.ts >> desktop navigation exposes a real pilot destination
- Location: tests/landing/browser/landing.spec.ts:34:5
...
Locator:  locator('.cv-nav__links .cv-nav__cta')
...
Call log:
  ...
  - waiting for locator('.cv-nav__links .cv-nav__cta')
    19 × locator resolved to <a class="cv-nav__cta" href="https://review.challanse.constrovet.com/">Client Sign In</a>
